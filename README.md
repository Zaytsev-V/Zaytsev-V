...
**Превращаю данные в управленческие решения**. Сочетание многолетнего опыта в ритейле/логистике и современных инструментов анализа (Python/SQL).

**Обо мне**

Я — аналитик с глубоким пониманием бизнес-процессов «изнутри». До погружения в Data Analysis я управлял продажами и закупками (B2B/B2C), отвечал за P&L, оптимизацию складов и автоматизацию логистики.
